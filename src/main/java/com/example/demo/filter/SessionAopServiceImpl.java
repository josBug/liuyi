...
public class SessionAopServiceImpl{
    ...
    @Pointcut("within(com.example.demo.processor.DemoServiceImpl)")
...
//        String userName = pUserInfoHibernateDao.checkKsid(lYopRequest.getSession());
//        if (userName == null || userName.isEmpty()) {
//            throw new Exception("请重新登录");
//        }
//        if (!userName.equals(lYopRequest.getUserName())) {
